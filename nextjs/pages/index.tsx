...
const Home = () => {
  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      <div className="flex">
        <div className="flex-none p-12  w-64 h-screen bg-blue-500">
          <p className="text-white 2xl p-2"> Dashboard</p>
          <p className="text-white 2xl p-2"> Manag Ads</p>

          <p className="text-white 2xl p-2"> create Ad</p>

          <p className="text-white 2xl p-2"> Inquiries</p>
